...
class SequentialMonteCarlo(Iterator):
    ...
    Attributes:
        ...
        mcmc_kernel (MetropolisHastings): Forward kernel for the rejuvenation steps.
    ...
    def __init__(
        ...
        """Initialize the SequentialMonteCarlo class.
        ...
        self.mcmc_kernel = MetropolisHastings(
            model=model,
