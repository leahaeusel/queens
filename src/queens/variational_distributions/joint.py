...
from queens.utils.type_hinting import Array1xN
...
class Joint(Variational):
    ...
    def reconstruct_distribution_parameters(self, variational_parameters: np.ndarray) -> list:
    ...
    def _zip_variational_parameters_distributions(self, variational_parameters: np.ndarray) -> zip:
    ...
    def _zip_variational_parameters_distributions_samples(
        self, variational_parameters: np.ndarray, samples: np.ndarray
    ) -> zip:
